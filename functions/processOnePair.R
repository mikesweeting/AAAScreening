################################################################################
# processOnePair
# Generate and analyze one person - actually one pair of twins/clones, of 
# which one gets the "screening" treatment and one gets "noScreening". 
# This is run in parallel by processPersons. 

#@ processOnePair.R was previously called processOnePerson.R. 

# This returns result, which contains:
...
processOnePair <- function(personNumber, v0, v1other, v2, updateProgress) {
  ...
  if (is.function(updateProgress)) {
    text <- "Calculating differences between invited and not invited groups"
